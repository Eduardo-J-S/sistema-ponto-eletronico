      ...
      {!isDrawerOpen && (
        ...
        <form onSubmit={handleSubmitFuncionario}>
          ...
          <input
            ...
            disabled={isFuncionarioAdded}
          />
          <button type="submit" disabled={isFuncionarioAdded}>Adicionar Funcionário</button>
        </form>

        {isFuncionarioAdded && (
            <div className="user-info">
              <h2>Informações do Usuário</h2>
              <p><strong>Funcionário ID:</strong> {horario.funcionarioId}</p>
              <p><strong>Nome:</strong> {funcionario.nome}</p>
              <p><strong>Email:</strong> {funcionario.email}</p>
              <p><strong>Telefone:</strong> {funcionario.telefone}</p>
              <p><strong>Email:</strong> {funcionario.matricula}</p>
              <p><strong>Empresa:</strong> {funcionario.cpf}</p>
        ...
        <form onSubmit={handleSubmitHorario}>
          ...
          <input
            ...
            disabled={!isHorarioEnabled}
          />
          <button type="submit" disabled={!isHorarioEnabled}>Adicionar Horário</button>
        </form>
      </div>
      </div>
    </div>
